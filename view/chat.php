...
<html>
	...
	<div align=center>
		<iframe name="chat" src="../controller/chat.php" width="70%" height="550px"style="background-color:#75A0B0;" ></iframe>
		<iframe name="speak" src="../controller/speak.php" width="70%" height="50px" style="background-color:#75A0B0;"></iframe>
	</div>
	</body>
</html>
